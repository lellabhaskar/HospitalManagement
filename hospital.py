...
class AllPatientDetails(Resource):
    def get(self):
        ...
        for patientdata in data:
            dictpatient = {'id': patientdata.id, 'phone_number': patientdata.phone_number, 'age': patientdata.age, 'bed_type': patientdata.bed_type,'address':patientdata.address,'state':patientdata.state,'city':patientdata.city,'patient_status':patientdata.patient_status}
